    ...
    public class PHMenue
    {
        public static void PHSubMenue()
        {
            ...
            do
            {
                ...
                Console.WriteLine("Sie können \"exit\" eingeben, um das gesamte Programm zu beenden, oder \n\nSie können \"mainmenu\" eingeben, um jederzeit zum Untermenü zurückzukehren!");
